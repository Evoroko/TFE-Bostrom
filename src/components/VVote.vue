    ...
    <div class="endscreen" v-if="hasChosen == true">
        ...
        <div class="endscreen__thanks">
            ...
            <div>
                ...
                <p>Suivez le projet sur les réseaux sociaux pour être informé de la suite.</p>
            </div>
            
            <ul class="socials endscreen__socials">
                <li class="socials__el socials__el--insta"><a target="_blank" href="https://www.figma.com/proto/9lRxCha1xiCkgYI3r115kG/TFE?page-id=606%3A3739&type=design&node-id=606-4953&viewport=326%2C372%2C0.71&scaling=min-zoom&starting-point-node-id=606%3A4953&show-proto-sidebar=1">Instagram</a></li>
                <li class="socials__el socials__el--twitter"><a target="_blank" href="https://www.figma.com/proto/9lRxCha1xiCkgYI3r115kG/TFE?page-id=606%3A3739&type=design&node-id=606-5751&viewport=326%2C372%2C0.71&scaling=min-zoom&starting-point-node-id=606%3A5751&show-proto-sidebar=1">Twitter</a></li>                
            </ul>            
        </div>
    ...
    <div class="bg bg--white">
        <div class="code">
            <div class="code__container">
                ...
                <VButton class="vote__button" :class="{'vote__button--active' : isOneSelected == true}" @click="close()">Voter</VButton>
                <p class="vote__disclaimer">Disponible jusqu'au 26/06/23 à 14h UTC+2. Passé ce délai, votre vote ne sera pas comptabilisé.</p>
            </div>
