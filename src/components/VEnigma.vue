        ...
        if (
          ...
          for (let specialDialog of props.levelDialogs) {
            if ('interaction-' + selectedObject.value == specialDialog.name) {
              ...
              if (specialDialog.object == inventoryActive.value) {
                // si l'interaction spéciale se fait bien avec l'objet actif
                if (specialDialog.conditions) {
                  ...
                  if (
                    conditionsMet == specialDialog.conditions.requires.length
                  ) {
                    // Si tout ce qui devait être activé pour le dialogue nécessitant des conditions, renvoie le dialogue approprié
